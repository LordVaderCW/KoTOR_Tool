    ...
    Public NotInheritable Class KotorThemeManager
        ...
        Public Shared Function LoadTheme(ByVal themeName As String) As KotorTheme
            ...
            Try
                ...
                theme.ErrorTitleText = GetColor(data, "ErrorDialog", "TitleText", theme.ErrorTitleText)
                theme.ErrorSubtitleText = GetColor(data, "ErrorDialog", "SubtitleText", theme.ErrorSubtitleText)
                theme.ErrorAccent = GetColor(data, "ErrorDialog", "Accent", theme.ErrorAccent)
                theme.ErrorSummaryBack = GetColor(data, "ErrorDialog", "SummaryBack", theme.ErrorSummaryBack)
                theme.ErrorSummaryBorder = GetColor(data, "ErrorDialog", "SummaryBorder", theme.ErrorSummaryBorder)
                theme.ErrorSummaryText = GetColor(data, "ErrorDialog", "SummaryText", theme.ErrorSummaryText)
                theme.ErrorFieldLabelText = GetColor(data, "ErrorDialog", "FieldLabelText", theme.ErrorFieldLabelText)
                theme.ErrorValueText = GetColor(data, "ErrorDialog", "ValueText", theme.ErrorValueText)
        ...
        Private Shared Function BuildThemeIni(ByVal theme As KotorTheme) As String
            ...
            sb.AppendLine()
            sb.AppendLine("[ErrorDialog]")
            sb.AppendLine("TitleText=" & ColorToIni(theme.ErrorTitleText))
            sb.AppendLine("SubtitleText=" & ColorToIni(theme.ErrorSubtitleText))
            sb.AppendLine("Accent=" & ColorToIni(theme.ErrorAccent))
            sb.AppendLine("SummaryBack=" & ColorToIni(theme.ErrorSummaryBack))
            sb.AppendLine("SummaryBorder=" & ColorToIni(theme.ErrorSummaryBorder))
            sb.AppendLine("SummaryText=" & ColorToIni(theme.ErrorSummaryText))
            sb.AppendLine("FieldLabelText=" & ColorToIni(theme.ErrorFieldLabelText))
            sb.AppendLine("ValueText=" & ColorToIni(theme.ErrorValueText))
            sb.AppendLine()
